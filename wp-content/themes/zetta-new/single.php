...
?>
	...
	<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		...
		<div <?php post_class('newSingle') ?> id="post-<?php the_ID(); ?>">
            ...
            <?php if (get_the_author() == "Courtenay Troxel"){?><span class="theAuthor">by <a href = "/author/courtenay" rel="author" class="author"><?php the_author() ?></a></span><?php } else {?> <span class="theAuthor">by <a href = "/management.php" rel="author"><?php the_author() ?></a></span> <?php  } ?>
