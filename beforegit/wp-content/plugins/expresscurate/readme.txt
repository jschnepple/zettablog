...
* **Social Media Promotion** - The Social Media Widget integrates your Social Media Publishing efforts with ExpressCurate. This is a single complex for social media promotions, content optimization and sharing.
...
= 2.0.4 =
* Keywords Interest Over Time widget.
* Keywords Related Topics widget.
* A problem in Keywords page is fixed.
* Problems with Google Alerts and Feedburner RSS are fixed.
* Miscellaneous bug fixes and improvements.
...
* News page is redesigned.
* Miscellaneous bug fixes and improvements.

= 1.2.22 =
* Problems with WooCommerce are fixed.
* Problems with custom post types are fixed.
* Miscellaneous bug fixes and improvements.
...
= 1.2.19 =
* Keyword analytics fixes and improvements.
* "Image Placement" setting and Featured image handling problems are fixed.
* Miscellaneous bug fixes and improvements.
